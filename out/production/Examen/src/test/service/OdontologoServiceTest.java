...
public class OdontologoServiceTest {
  ...
  public void testOdontologoServiceListAllOdontologo(){
    ...
    // When
    List<Odontologo> odontologoListObtained = odontologoService.listAllOdontologo();
  ...
  @Test
  public void testFindByRegistrationOdontologo(){
    // Given
    OdontologoService odontologoService = new OdontologoService();
    Odontologo odontologoExpected = new Odontologo(1, "Dr", "Muelas");
    // When
    Odontologo odontologoRetrievedFromDB = odontologoService.findByRegistrationOdontologo(1);
    // Then
    Assertions.assertEquals(odontologoExpected,odontologoRetrievedFromDB);
